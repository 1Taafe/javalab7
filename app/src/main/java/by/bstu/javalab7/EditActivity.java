...
public class EditActivity extends AppCompatActivity {
    ...
    public void createAction(View view) {
        ...
        int time = Integer.parseInt(String.valueOf(timeInput.getText()));
    ...
    public void editAction(String name, String desc, String image, String category, int time, int isfavorite){
